      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div ref={imageRef} className="relative h-[500px] rounded-xl overflow-hidden shadow-xl">
            <div className="absolute inset-0 bg-gradient-to-t from-navy-blue/80 to-transparent z-10"></div>
            <Image 
          ...
          <div ref={contentRef} className="space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-color-navy-blue dark:text-color-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6">
              <div className="bg-color-navy-blue/10 dark:bg-color-navy-blue/30 p-5 rounded-lg">
                <h3 className="text-color-navy-blue dark:text-color-white text-xl font-semibold mb-1">Our Vision</h3>
