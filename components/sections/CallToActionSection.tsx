        ...
        >
          <div ref={contentRef} className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-5">
              ...
              <a 
                href="/equipment" 
                className="px-8 py-4 bg-transparent border-2 border-color-white text-color-white font-medium rounded-full hover:bg-color-white/10 hover:scale-105 transition-all"
              >
                Browse Equipment
              </a>
            </div>
