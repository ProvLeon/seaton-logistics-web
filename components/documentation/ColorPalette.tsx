...
const colors: ColorItem[] = [
  {
    ...
    hex: '#000000',
    description: 'Represents elegance, power, and sophistication.',
    textColor: 'white'
  },
  {
    name: 'Safety Orange',
    ...
    hex: '#FF6600',
    description: 'Primary brand color evoking energy, visibility, and safety.',
    textColor: 'white'
  },
  {
    name: 'Charcoal Gray',
    ...
    hex: '#333333',
    description: 'Secondary color for UI elements and backgrounds.',
    textColor: 'white'
  },
  {
    name: 'White',
    ...
    hex: '#FFFFFF',
    description: 'Adds clarity and simplicity to layouts.',
    textColor: 'black'
  },
  {
    name: 'Light Gray',
...
export default function ColorPalette() {
  return (
    <div className="py-8">
      <h2 className="text-3xl font-bold mb-8 text-color-black dark:text-color-white">Seaton Logistics Brand Colors</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {colors.map((color) => (
          ...
          >
            ...
            <div className="p-5">
              <h3 className="text-xl font-bold text-color-black dark:text-color-white">{color.name}</h3>
      ...
      <div className="mt-12 pt-8 border-t border-color-light-gray dark:border-color-charcoal-gray">
        <h3 className="text-2xl font-bold mb-6 text-color-black dark:text-color-white">Usage Guidelines</h3>
        <ul className="list-disc pl-6 space-y-3 text-color-charcoal-gray/80 dark:text-color-white/80">
          <li><span className="font-semibold text-color-black dark:text-color-white">Text Color:</span> Use <code className="bg-color-light-gray dark:bg-color-charcoal-gray px-2 py-0.5 rounded text-color-safety-orange">text-color-black</code> format</li>
          <li><span className="font-semibold text-color-black dark:text-color-white">Background Color:</span> Use <code className="bg-color-light-gray dark:bg-color-charcoal-gray px-2 py-0.5 rounded text-color-safety-orange">bg-color-black</code> format</li>
          <li><span className="font-semibold text-color-black dark:text-color-white">With Opacity:</span> Use <code className="bg-color-light-gray dark:bg-color-charcoal-gray px-2 py-0.5 rounded text-color-safety-orange">bg-color-black/80</code> for 80% opacity</li>
          <li><span className="font-semibold text-color-black dark:text-color-white">Primary Buttons:</span> Use Safety Orange for main calls-to-action</li>
          <li><span className="font-semibold text-color-black dark:text-color-white">Secondary Buttons:</span> Use Black or transparent with white borders</li>
        </ul>
      </div>
      
      <div className="mt-16 pt-8 border-t border-color-light-gray dark:border-color-charcoal-gray">
        <h3 className="text-2xl font-bold mb-6 text-color-black dark:text-color-white">Example Usage</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
          <div className="border border-color-light-gray dark:border-color-charcoal-gray rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="p-8 space-y-6 bg-color-white dark:bg-color-charcoal-gray/20">
              ...
              <div>
                <button className="bg-color-black text-color-white px-7 py-3 rounded-full font-medium hover:bg-opacity-90 hover:shadow-md transition-all">
                  Secondary Button
                </button>
              </div>
              <div>
                <button className="border-2 border-color-black dark:border-color-white text-color-black dark:text-color-white px-7 py-3 rounded-full font-medium hover:bg-color-black/5 dark:hover:bg-color-white/10 transition-all">
                  Outline Button
                </button>
              </div>
            </div>
          ...
          <div className="border border-color-light-gray dark:border-color-charcoal-gray rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="p-8 space-y-5 bg-color-white dark:bg-color-charcoal-gray/20">
              <h5 className="text-color-black dark:text-color-white text-2xl font-bold">Black Heading</h5>
              ...
              <div className="bg-color-light-gray dark:bg-color-black/30 p-5 rounded-lg">
